...
namespace UWPPlayground.Common.d3dx12
{
    ...
    public static unsafe class CD3DX12_RESOURCE_DESC
    {
        ...
        public static byte PlaneCount(this D3D12_RESOURCE_DESC obj, ID3D12Device* pDevice) => Functions.D3D12GetFormatPlaneCount(pDevice, obj.Format);
        ...
        public static uint CalcSubresource(this D3D12_RESOURCE_DESC obj, uint MipSlice, uint ArraySlice, uint PlaneSlice) => Functions.D3D12CalcSubresource(MipSlice, ArraySlice, PlaneSlice, obj.MipLevels, obj.ArraySize());
    }
}